...
public class OI {
    ...
    public JoystickButton FiveButton;
    public JoystickButton r_Bumper;
    public JoystickButton SixButton;
    public JoystickButton ThreeButton;
    public JoystickButton FourButton;
    ...
    public OI() {
       ...
       FiveButton.whileHeld(new Climb());
       FiveButton.whenReleased(new StopClimb());
       
       // slowly climbing the rope
       ThreeButton = new JoystickButton(xbox_Joystick, 3); 
       ThreeButton.whileHeld(new SlowClimbing());
       ThreeButton.whenReleased(new StopClimb());
       
       // Invert climbing the rope
       SixButton = new JoystickButton(xbox_Joystick, 6);
       SixButton.whileHeld(new InvertClimbing());
       SixButton.whenReleased(new StopClimb());
       
       // slowly Invert climbing the rope
       FourButton = new JoystickButton(xbox_Joystick, 4);
       FourButton.whileHeld(new SlowInvertC());
       FourButton.whenReleased(new StopClimb());


        // SmartDashboard Buttons
        SmartDashboard.putData("LeftStation", new LeftStation());
        SmartDashboard.putData("RightStation", new RightStation());
        SmartDashboard.putData("MiddleStation", new MiddleStation());
        ...
        SmartDashboard.putNumber("Rolling", RobotMap.shootingshootSC.get());
