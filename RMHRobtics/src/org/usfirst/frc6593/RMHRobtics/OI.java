...
public class OI {
	...
	public OI() {
        ...
        SmartDashboard.putData("AutoDriveFastForward", new AutoDriveFastForward(0));
        SmartDashboard.putData("AutoDriveSlowForward", new AutoDriveSlowForward(0));
        SmartDashboard.putNumber("GyroKP", DriveTrain.Kp);
